    ...
    return (
        <div className={cn("w-full space-y-4", "lg:space-y-5")}>
            ...
            <div className='space-y-6'>
                <h6 className={cn("font-semibold", "lg:text-xl")}>Social Links</h6>
                <div className={cn("flex items-center gap-4", "lg:text-base")}>
            ...
            <Separator className="my-6 lg:max-w-4xl" />
            <div className='space-y-6'>
                <h6 className={cn("font-semibold",  "lg:text-xl")}>More informations</h6>
                <div className={cn("flex items-center gap-4")}>
                    ...
                    <p className={cn("text-sm", "lg:text-base")}>Toulon, France</p>
                </div>
            </div>
        </div>
    );
